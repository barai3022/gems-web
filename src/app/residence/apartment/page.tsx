...
const page = () => {
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen space-y-6">
            ...
            <p className="text-black text-center py-2"> Daily Solar Power Consumption</p>
                                <div className='bg-gray-900  h-80'>
                                    <ChartCard title="Real-Time Solar Consumption (kWh)">
                                        <BarChartView
                                            data={dailyGridConsumption}
                                            xKey="time"
                                            yKey="kwh"
                                            name="Daily Solar Power Consumption"
                                        />
                                    </ChartCard>
                                </div>
                                <p className="text-black text-center py-2"> Monthly Consumption</p>
                                <div className='bg-gray-900  h-80'>
